...
public class ConfigMessages {
    ...
    public final static String COLLECTION_INIT_ERROR = "Invalid action in App Configuration. This action can be performed only after a successful initialization and set collectionId value operation. Please check the initialization and setCollectionId sections for errors.";
    ...
    public final static String CONFIG_HANDLER_METHOD_ERROR = "Invalid action in ConfigurationHandler. Should be a method/function";
    public final static String CONFIG_API_ERROR = "Invalid configuration. Verify the collectionId, apikey, guid and region.";
